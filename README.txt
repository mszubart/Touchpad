...
Second big issue:
When using custom server, Touchpad forgets to what was connected after restart.  Solution: Touchpad now tries to connect to default server after resume. Default server is configurable from 'Properties' menu.
